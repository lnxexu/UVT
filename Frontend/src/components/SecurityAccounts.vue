    ...
    <div class="secAcc-list-container" v-if="closeSekyu">
      ...
      <div class="main-content w3-half">
        ...
        <div class="w3-row w3-half">
          <div class="w3-col s9">
            <input type="text" class="w3-input" v-model="searchQuery" placeholder="Search for security guards" @input="filterGuards()" />
      ...
      <div class="main-content w3-half">
        ...
        <div class="w3-row w3-half">
          <div class="w3-col s9">
            <input type="text" class="w3-input" v-model="searchQueryStaff" placeholder="Search for OSAD staffs" @input="filterStaffs()"  />
