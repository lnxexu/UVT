<template>
  ...
  <div v-if="showConfirmPopup" class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width: 600px">
    <div class="w3-container w3-padding-16 w3-light-grey">
      <h2>Confirm Approval</h2>
      <p>Are you sure you want to approve this account?</p>
      <div class="buttons">
        <button @click="approve">Yes, approve</button>
        <button @click="showConfirmPopup = false">No, go back</button>
      </div>
    </div>
  </div>
