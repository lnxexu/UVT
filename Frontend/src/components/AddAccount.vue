<template>
    <div class="addStudent-list-container" v-if = "closeAddStudent">
        ...
        <div class=" w3-row-padding">
            ...
            <div class="w3-center">
                <button class="button-57" type="submit" @click=""><i class="fa fa-paper-plane"></i> <span class="text"> ADD STUDENT </span><span><i class="fa fa-paper-plane-o"></i> ADD STUDENT</span></button>
            </div>
        </div>
    </div>
</template>
