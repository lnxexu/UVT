describe('User Routes Test', () => {
  ...
  describe('Signup OSAD', () => {
    ...
    it('Signup OSAD ACCOUNT', () => {
      ...
      cy.visit('http://localhost:5173')
      cy.get('.w3-hide-small > [href="#signup"]').click()
      cy.get(':nth-child(3) > :nth-child(2) > .w3-input').type('yuki')
      cy.get(':nth-child(3) > :nth-child(3) > .w3-input').type('nery')
      cy.get(':nth-child(3) > :nth-child(4) > .w3-select').click()

      cy.get(':nth-child(3) > :nth-child(5) > .w3-input').type('24')
      cy.get(':nth-child(3) > :nth-child(6) > .w3-select').click()
