...
it('can POST details', () => {
  cy.visit('http://127.0.0.1:8000/docs#/Violation%20Details/add_violation_violationDetailsPost__post')
  cy.get('#operations-Violation_Details-add_violation_violationDetailsPost__post > .opblock-summary > .opblock-summary-control').should('be.visible').contains('Add Violation').click()
  cy.get('#operations-Violation_Details-add_violation_violationDetailsPost__post > .opblock-summary > .opblock-summary-control').click()
  cy.get('.btn').click()
